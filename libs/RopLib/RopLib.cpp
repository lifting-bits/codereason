...
static void InitHWCaps(TargetArch t, TargetInfo *ti) {
  if ( t.ta == AMD64 ) {
    ti->guestHWcaps = VEX_HWCAPS_AMD64_SSE3|
    ...
    maxNumStatements(m)
{
    ...
    this->decodeCtx = initDecodeLib(ti, true, true);
