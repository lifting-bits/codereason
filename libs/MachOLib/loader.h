 ...
 */
struct mach_header {
	boost::uint32_t	magic;		/* mach magic number identifier */
	cpu_type_t	cputype;	/* cpu specifier */
	cpu_subtype_t	cpusubtype;	/* machine specifier */
	boost::uint32_t	filetype;	/* type of file */
	boost::uint32_t	ncmds;		/* number of load commands */
	boost::uint32_t	sizeofcmds;	/* the size of all the load commands */
...
struct mach_header_64 {
	...
	boost::uint32_t	sizeofcmds;	/* the size of all the load commands */
	boost::uint32_t	flags;		/* flags */
	boost::uint32_t	reserved;	/* reserved */
};
